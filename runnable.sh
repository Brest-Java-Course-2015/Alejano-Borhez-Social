...
docker run -d --net=socialserver --name=rest alexanderborohov/socialrest:1.1
docker run -d --net=socialserver --name=app -p 8080:8080 alexanderborohov/socialapp:1.1